...
class PegawaiCrud extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.pegawai-crud', compact('pegawais'))->layout('layouts.app');
    }

    public function resetInput()
    {
        $this->reset([
            'pegawaiId', 'NIK_NIP', 'NIDN', 'NUPTK', 'nama', 'status_pegawai',
            'status_nikah', 'tanggal_lahir','sex', 'telp', 'email', 'alamat', 'unit_kerja', 'NPWP',
            'isEdit'
        ]);
    }
    ...
    public function store()
    {
        ...
        Pegawai::create($this->only([
            'NIK_NIP', 'NIDN', 'NUPTK', 'nama', 'status_pegawai',
            'status_nikah', 'tanggal_lahir', 'sex', 'telp', 'email', 'alamat', 'unit_kerja', 'NPWP'
        ]));
        $this->resetInput();
    ...
    public function update()
    {
        ...
        'NIK_NIP', 'NIDN', 'NUPTK', 'nama', 'status_pegawai',
        'status_nikah', 'tanggal_lahir', 'sex', 'telp', 'email',
        'alamat', 'unit_kerja', 'NPWP'
    ]));

    // Dispatch close modal event
    $this->dispatch('close-modal');

    // Reset form dan state setelah modal tertutup
    $this->resetInput();
    $this->isEdit = false;
