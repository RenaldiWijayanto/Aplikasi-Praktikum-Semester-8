            ...
            <tbody>
                @forelse ($pegawais as $index => $pegawai)
                    <tr>
                        ...
                        <td>{{ $pegawai->NPWP }}</td>
                        <td>
                            <button class="btn btn-sm btn-warning" wire:click="edit({{ $pegawai->id }})" data-bs-toggle="modal" data-bs-target="#pegawaiModal">Edit</button>
                            <button class="btn btn-sm btn-danger" wire:click="delete({{ $pegawai->id }})" onclick="confirm('Yakin hapus data ini?') || event.stopImmediatePropagation()">Hapus</button>
                        </td>
                    </tr>
                @empty
...
<script>
    ...
    window.addEventListener('open-modal', () => {
        const modal = new
bootstrap.Modal(document.getElementById('pegawaiModal'));
        modal.show();
    });
</script>
@endpush
